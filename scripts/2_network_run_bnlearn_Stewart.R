...
## Wallace 
#
counts <- read.csv(file="dicho_Stewart_samples_genusmicro_aclame_iceberg_megaresgroup.csv", row.names=1,header=TRUE)
...
save.image(file="network_Stewart_100rep_dicho_all_rumen_data.RData")
