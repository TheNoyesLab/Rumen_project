...
#####
###
Shi_samples_phylum_microbiome_samples = which(pData(microbiome_analytic_data[[6]])$Study == "Shi" )
Shi_samples_phylum_microbiome <- microbiome_analytic_data[[6]][, Shi_samples_phylum_microbiome_samples]
...
Shi_samples_ACLAME_samples = which(pData(ACLAME_analytic_data[[4]])$Study == "Shi" )
Shi_samples_ACLAME <- ACLAME_analytic_data[[4]][, Shi_samples_ACLAME_samples]
...
Shi_samples_MEGARes_samples = which(pData(MEGARes_analytic_data[[3]])$Study == "Shi" )
Shi_samples_MEGARes <- MEGARes_analytic_data[[3]][, Shi_samples_MEGARes_samples]
...
Shi_samples_ICEBerg_samples = which(pData(ICEBerg_analytic_data[[4]])$Study == "Shi" )
Shi_samples_ICEBerg <- ICEBerg_analytic_data[[4]][, Shi_samples_ICEBerg_samples]
...
# write the counts
write.csv(final_Shi_network_counts, "network_counts/counts_Shi_samples_genusmicro_aclame_iceberg_megaresgroup.csv", row.names = FALSE)
...
write.csv(final_Shi_dichotemized_network_counts, "network_counts/dicho_Shi_samples_genusmicro_aclame_iceberg_megaresgroup.csv", row.names = FALSE)
...
#####
###
Hess_samples_phylum_microbiome_samples = which(pData(microbiome_analytic_data[[6]])$Study == "Hess" )
Hess_samples_phylum_microbiome <- microbiome_analytic_data[[6]][, Hess_samples_phylum_microbiome_samples]
...
Hess_samples_ACLAME_samples = which(pData(ACLAME_analytic_data[[4]])$Study == "Hess" )
Hess_samples_ACLAME <- ACLAME_analytic_data[[4]][, Hess_samples_ACLAME_samples]
...
Hess_samples_MEGARes_samples = which(pData(MEGARes_analytic_data[[3]])$Study == "Hess" )
Hess_samples_MEGARes <- MEGARes_analytic_data[[3]][, Hess_samples_MEGARes_samples]
...
Hess_samples_ICEBerg_samples = which(pData(ICEBerg_analytic_data[[4]])$Study == "Hess" )
Hess_samples_ICEBerg <- ICEBerg_analytic_data[[4]][, Hess_samples_ICEBerg_samples]
...
# write the counts
write.csv(final_Hess_network_counts, "network_counts/counts_Hess_samples_genusmicro_aclame_iceberg_megaresgroup.csv", row.names = FALSE)
...
write.csv(final_Hess_dichotemized_network_counts, "network_counts/dicho_Hess_samples_genusmicro_aclame_iceberg_megaresgroup.csv", row.names = FALSE)
...
#####
###
Stewart_samples_phylum_microbiome_samples = which(pData(microbiome_analytic_data[[6]])$Study == "Stewart" )
Stewart_samples_phylum_microbiome <- microbiome_analytic_data[[6]][, Stewart_samples_phylum_microbiome_samples]
...
Stewart_samples_ACLAME_samples = which(pData(ACLAME_analytic_data[[4]])$Study == "Stewart" )
Stewart_samples_ACLAME <- ACLAME_analytic_data[[4]][, Stewart_samples_ACLAME_samples]
...
Stewart_samples_MEGARes_samples = which(pData(MEGARes_analytic_data[[3]])$Study == "Stewart" )
Stewart_samples_MEGARes <- MEGARes_analytic_data[[3]][, Stewart_samples_MEGARes_samples]
...
Stewart_samples_ICEBerg_samples = which(pData(ICEBerg_analytic_data[[4]])$Study == "Stewart" )
Stewart_samples_ICEBerg <- ICEBerg_analytic_data[[4]][, Stewart_samples_ICEBerg_samples]
...
# write the counts
write.csv(final_Stewart_network_counts, "network_counts/counts_Stewart_samples_genusmicro_aclame_iceberg_megaresgroup.csv", row.names = FALSE)
...
write.csv(final_Stewart_dichotemized_network_counts, "network_counts/dicho_Stewart_samples_genusmicro_aclame_iceberg_megaresgroup.csv", row.names = FALSE)
...
#####
###
Wallace_samples_phylum_microbiome_samples = which(pData(microbiome_analytic_data[[6]])$Study == "Wallace" )
Wallace_samples_phylum_microbiome <- microbiome_analytic_data[[6]][, Wallace_samples_phylum_microbiome_samples]
...
Wallace_samples_ACLAME_samples = which(pData(ACLAME_analytic_data[[4]])$Study == "Wallace" )
Wallace_samples_ACLAME <- ACLAME_analytic_data[[4]][, Wallace_samples_ACLAME_samples]
...
Wallace_samples_MEGARes_samples = which(pData(MEGARes_analytic_data[[3]])$Study == "Wallace" )
Wallace_samples_MEGARes <- MEGARes_analytic_data[[3]][, Wallace_samples_MEGARes_samples]
...
Wallace_samples_ICEBerg_samples = which(pData(ICEBerg_analytic_data[[4]])$Study == "Wallace" )
Wallace_samples_ICEBerg <- ICEBerg_analytic_data[[4]][, Wallace_samples_ICEBerg_samples]
...
# write the counts
write.csv(final_Wallace_network_counts, "network_counts/counts_Wallace_samples_genusmicro_aclame_iceberg_megaresgroup.csv", row.names = FALSE)
...
write.csv(final_Wallace_dichotemized_network_counts, "network_counts/dicho_Wallace_samples_genusmicro_aclame_iceberg_megaresgroup.csv", row.names = FALSE)
