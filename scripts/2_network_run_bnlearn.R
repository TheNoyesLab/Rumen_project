...
counts <- read.csv(file="dicho_LA_tylan1_XIT_kuner_samples_Phylum_counts_seperate_nodes.csv", row.names=1,header=TRUE)
...
save.image(file="network_100rep_dicho_Shi_data.RData")
